...
/**
 *  手势路径绘制， 用一个类(GestureDrawline.java)来实现，复写onTouchEvent()方法，
 *  在这个方法里面监听TouchEvent事件: ACTION_DOWN、ACTION_MOVE、ACTION_UP事件，
 *  来绘制手势连接不同点之间的路径；
 *
 */
public class GestureDrawline extends View {
	...
	public int POINT_STATE_NORMAL = 0; // 正常状态

	public int POINT_STATE_SELECTED = 1; // 按下状态

	public int POINT_STATE_WRONG = 2; // 错误状态
